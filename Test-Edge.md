...
1. There is many new issues about some same new feature or bug. Yes, when some notices new feature that is already [at ChangeLog](https://github.com/wekan/wekan/blob/master/CHANGELOG.md), they also add issue about it, usually asking "Can this feature be turned off or made optional?".
