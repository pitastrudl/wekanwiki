...
[Chat: Text/Voice/Video](https://en.wikipedia.org/wiki/Online_chat) | [Skype](https://en.wikipedia.org/wiki/Skype) | [Slack](https://en.wikipedia.org/wiki/Slack_(software)) | [Rocket.Chat](https://rocket.chat), [Friend](https://friendup.cloud), [Riot](https://about.riot.im) | [Sandstorm](https://sandstorm.io) / [Rocket.Chat](https://rocket.chat)
