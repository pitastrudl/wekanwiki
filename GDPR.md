...
[Intel AMT Checker for Linux](https://github.com/mjg59/mei-amt-check) and it's [HN discussion](https://news.ycombinator.com/item?id=14335159). For me it shows Intel AMT is present, AMT is unprovisioned. I need to check all hardware and disable AMT where possible.
...
Compliance | - | - | - | [SIMP](https://simp-project.com) see [FLOSS426](https://twit.tv/shows/floss-weekly/episodes/426), [Saltstack](https://saltstack.com/infrastructure-compliance)